...
module Automation
  ...
  class Analyser < Task
    ...
    def initialize(run_name = environment.config_manager['run.name'])
      super()
    ...
    def find_added_tests
      ...
      added_tests.each do |test_result|
        @results_database.add_test_result_change(@run_result, test_result.test, Automation::Change::TestAdded)
      end
    end
    ...
    def find_removed_tests
      ...
      removed_tests.each do |test_result|
        @results_database.add_test_result_change(@run_result, test_result.test, Automation::Change::TestRemoved)
      end
    end
    ...
    def find_started_failing_tests
      ...
      failed_tests.each do |test_result|
        @results_database.add_test_result_change(@run_result, test_result.test, Automation::Change::TestStartedFailing)
      end
    end
    ...
    def find_started_passing_tests
      ...
      passed_tests.each do |test_result|
        @results_database.add_test_result_change(@run_result, test_result.test, Automation::Change::TestStartedPassing)
      end
    end
