...
module Automation
  ...
  class TestInfo
    ...
    def initialize(test_name)
      ...
      @average = results_database.with_connection { results_database.get_test_average_time(test_name, 10, 0) }
    end
  ...
  class TestMonitor < Automation::Manager::Service
    ...
    def run
      ...
      until @stopped
        @mutex.synchronize { @results_database.with_connection { check_running_tests } }
        sleep(frequency)
      end
    end
